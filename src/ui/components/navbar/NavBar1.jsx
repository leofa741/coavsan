...
export const NavBar1 = () => {
  ...
  <NavLink  className="nav-link-drop"   to="/laboratorio9dejulio" ><button className="btn" data-bs-toggle="collapse" data-bs-target="#navbarCollapse"> 9deJulio </button></NavLink >
  </div>
</div>
